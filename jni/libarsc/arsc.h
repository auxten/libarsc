...
#endif
    std::vector<std::string> *  getLabel(bool inclValues, uint32_t label_id) const;
...
private:
    ...
    status_t add(const void* data, size_t size, void* cookie, bool copyData);
...
//    void print_value(const Package* pkg, const Res_value& value) const;
    void print_value(const Package* pkg, const Res_value& value, std::string * const utf8_value = NULL) const;
